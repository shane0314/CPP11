...
int main( int argc, char* args[] )
{
	...
	strcpy( group_ip, args[1] );
	int group_port = atoi( args[2] );
...
*/
	if( bind(socket_fd, (struct sockaddr*)&group_addr, sizeof(group_addr)) < 0 )
	{
	...
	mreq.imr_interface.s_addr = inet_addr( "192.168.0.29" );
